        ...
        <div className={styles.content}>
          ...
          <section id="components" className={styles.section}>
            ...
            <div className={styles.componentGrid}>
              ...
              <article className={styles.specimen}>
                <header><strong>Tiered choice tiles</strong><code>2단 · 점선 구분선</code></header>
                <div className={styles.choiceTiles}>
                  <button className={styles.choiceTileActive}><span>서울<small>1.45배</small></span></button>
                  <button><span>경기<small>1.09배</small></span></button>
                  <button><span>전남<small>0.68배</small></span></button>
                </div>
                <div className={styles.tierGroup}>
                  <p>서울은 구별로 한 번 더 조정해요 <small>(선택)</small></p>
                  <div className={styles.tierTiles}>
                    <button className={styles.choiceTileActive}><span>강남구<small>1.42배</small></span></button>
                    <button><span>송파구<small>0.94배</small></span></button>
                    <button><span>강북구<small>0.78배</small></span></button>
                  </div>
                </div>
              </article>

              <article className={styles.specimen}>
                <header><strong>Explain trigger &amp; sheet</strong><code>ⓘ · 스켈레톤</code></header>
                <p className={styles.explainAmount}>
                  3,954만원
                  <button type="button" aria-label="이 금액이 나온 이유 보기"><Info size={17} /></button>
                </p>
                <div className={styles.explainSheet}>
                  <p className={styles.explainAnswer}>
                    서울은 사교육비가 전국 평균보다 높고 강남구는 학원 수강료가 서울 평균보다
                    높아 두 계수를 곱한 2.07배가 적용됐어요.
                  </p>
                  <div className={styles.explainSkeleton} aria-hidden="true">
                    <span /><span /><span className={styles.explainSkeletonShort} />
                  </div>
                </div>
              </article>

              <article className={styles.specimen}>
                <header><strong>Source footnote</strong><code>출처 + 갱신 시점</code></header>
                <p className={styles.sourceNote}>
                  <Info size={14} aria-hidden="true" />
                  <span>
                    시도 배율: 통계청 KOSIS 초중고 사교육비조사 (2025년 조사) /
                    서울 내 구간 보정: 서울 열린데이터광장 학원 정보, 2026년 7월 기준
                  </span>
                </p>
              </article>
